...
cl = LINETCR.LINE()
cl.login(token ="EpYjB0oxJkYGjzmc0Bve.453WcOOPNKbLcf5cHGuQNG.VxYOw+N1h3MpkZXIB0F4cGJiI3bsXmEtKk4/VKNC0UE=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token ="Epzgbo8pblWQaMKHu0A4.3YiuYRSm9nbKSHsl0putTa.kV8lXK34E19tBywJl9/WqZyym8+zMBXwcCctQeyGrP8=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token ="EpAozjm54IZC2le8Ai81.NxBC8HJGAlZM+ygOv3vQ4q.HDAPdAaDTT4Vb04fB72inBOWaRHmiuRAP8o2IC0PNmA=")
ki2.loginResult()
...
║╚════════════
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
╄   Sasaji Arema Indonesia
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
╚═════════════"""

Setgroup =""" 
    Van De Sur Communitty"""
KAC=[cl,ki,ki2]
mid = cl.getProfile().mid
kimid = ki.getProfile().mid
ki2mid = ki2.getProfile().mid
Bots=[mid,kimid,ki2mid]
owner = ["ue39df00a8a299e4065085e4286052a9e"]
admin = ["ue39df00a8a299e4065085e4286052a9e"]
wait = {
    'contact':False,
    'autoJoin':True,
...
SEDIA VIP ANDROID  25K/VIP DAN SONGBOOK 10K/LAGU
ṡȗƿƿȏяṭєԀ ɞʏ:
  B1V // COSI // NS1 FAMILY""",
    "lang":"JP",
          ...
          if wait["Protectcancel"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                random.choice(KAC).sendText(op.param1, "Jangan Sok Deh.\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])   
            ...
            if msg.contentType == 13:
              if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"Sejak Kapan")
...
#-------------------- Protect Mode ------------
            elif msg.text in ["All on","Mode on"]:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["All off","Mode Off"]:
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              #if msg.from_ in admin:
                cl.sendText(msg.to, "testing testing")
#cl.s"Kates kates melu")
#cl.sendText(msg.to, "Penting....")
                try:
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        ki2.sendText(msg.to, "||Di Anu Oleh||%s\n||By : VanDeSur ||\n\n>Tukang Ngintip<\n%s-=Ngintip=-\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        ki.sendText(msg.to, "Mau apa loh")
#-----------------------------------------------
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"Kami Mau Bersih Bersih  Nih")
                    ki2.sendText(msg.to,"Room Dibersihin dulu\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'ue39df00a8a299e4065085e4286052a9e'}
                    cl.sendMessage(msg)
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    cl.sendText(msg.to,"Succes Sur...")
#cl.sendText(msg.to,"Mantap.... Sur")
                                except:
                                    cl.sendText(msg.to,"error")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di Room Kami")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","absen","Absen dulu","Respon"]:
              #if msg.from_ in admin:
              #  cl.sendText(msg.to,"Tukang Sayur On")
                ki.sendText(msg.to,"Raja Tikung Disini")
                ki2.sendText(msg.to,"Pangeran Tikung Hadir")
                ki.sendText(msg.to,"Semua sudah siap Gusti prabu\nSiap Protect Room\nAman Gak Aman Yang Penting Anu")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Bos Kami")
...
#---------------------
        if op.type == 17:
          ...
          cl.sendText(op.param1, "Selamat Datang  Di  " + ">>> " + str(ginfo.name) + " <<<" + "\n" + "Pekenalkan Saya " + ginfo.creator.displayName + " Yang Ganteng\n" + "Budayakan Baca Note !!! yah Kk 😊\nSemoga Bisa Nikung 😘")
          ki.sendText(op.param1, "Awas Hati hati Dengan " + ginfo.creator.displayName +" Dia Semprul")
          #ki2.sendText(op.param1,"Bener Si >> "  + ginfo.creator.displayName + " Memang semprul dan suka ngikung" )
    ...
    for zx in range(0,200):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                ...
                print "Status Sudah di Like jhon"
